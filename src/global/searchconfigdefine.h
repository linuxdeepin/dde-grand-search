...
#define GRANDSEARCH_PREFERENCES_GROUP  "Preferences_Group"
#define GRANDSEARCH_PREFERENCES_TRIGGERMODE "triggermode"
#define GRANDSEARCH_PREFERENCES_TRIGGERMODE_DEFAULT 0
#define GRANDSEARCH_PREFERENCES_TRIGGERMODE_MANUAL 1
