...
bool Utils::setWeightMethod(MatchedItem &item)
{
    ...
    } else if (search == GRANDSEARCH_CLASS_SETTING_CONTROLCENTER_V1 || search == GRANDSEARCH_CLASS_SETTING_CONTROLCENTER_V2) {
        ext.insert(GRANDSEARCH_PROPERTY_WEIGHT_METHOD,
...
bool Utils::isResetSearcher(QString searcher)
{
    static const QStringList searchers = {
        ...
        GRANDSEARCH_CLASS_SETTING_CONTROLCENTER_V1,
        GRANDSEARCH_CLASS_SETTING_CONTROLCENTER_V2
    };
...
QString Utils::appIconName(const MatchedItem &item)
{
    ...
    } else if (item.searcher == GRANDSEARCH_CLASS_SETTING_CONTROLCENTER_V1 || item.searcher == GRANDSEARCH_CLASS_SETTING_CONTROLCENTER_V2) {
