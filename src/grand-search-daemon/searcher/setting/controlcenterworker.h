 ...
 */
#ifndef CONTROLCENTERWORKER_H
#define CONTROLCENTERWORKER_H

#include "searcher/proxyworker.h"

class ControlCenterWorker : public ProxyWorker
{
public:
    explicit ControlCenterWorker(const QString &name, QObject *parent = nullptr);
